...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`email`,`fullName`,`passwordHash`,`isLoggedIn`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`email` = ?,`fullName` = ?,`passwordHash` = ?,`isLoggedIn` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<User> getUserById(final String id) {
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpEmail,_tmpFullName,_tmpPasswordHash,_tmpIsLoggedIn);
          } else {
            _result = null;
          }
          return _result;
